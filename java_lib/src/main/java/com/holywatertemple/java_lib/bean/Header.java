...
public class Header implements Serializable {
    ...
    public Header(String jossId, String name, String phoneNum, String jossType, String fendPrice, String fendTime, String extendTime, String title, String sheetName) {
        this.jossId = jossId;
        this.name = name;
